        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Edit Gallery - {{ $admin->title }}</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.gallery.update', $admin->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 col-sm-12">
                                <label for="username">Gallery Type</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-6">
                                <label for="password">Gallery Image</label>
                                <input type="file" name="image" id="image" class="form-control" />
                                <br />
                                <img src="{{ asset('gallerys/'.$admin->image) }}" alt="Gallery Image" width="100px"
                                    height="80px" />
                            </div>
                            <div class="form-group col-md-6 col-sm-6">
