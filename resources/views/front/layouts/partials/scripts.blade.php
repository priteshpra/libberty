...
<script src="{{ asset('front/assets/js/jquery.slimscroll.min.js') }}"></script>
...
<script src="{{ asset('front/assets/js/line-chart.js') }}"></script>
<!-- all pie chart -->
<script src="{{ asset('front/assets/js/pie-chart.js') }}"></script>
<!-- others plugins -->
